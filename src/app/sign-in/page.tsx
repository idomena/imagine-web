...
import { Loader2, AlertCircle, Eye, EyeOff, Zap, Rocket, Trophy } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-screen" style={{ background: 'rgb(var(--color-background))' }}>
      ...
      >
        ...
        <div className="pointer-events-none absolute -bottom-20 -right-20 h-[350px] w-[350px] rounded-full opacity-15"
        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-14">
          ...
          <div className="my-auto">
            ...
            >
              The marketplace<br />AI deserves.
            </motion.h2>
            <motion.p
            ...
            >
              {[
                { icon: <Zap className="h-4 w-4" />, text: 'Earn XP every time you launch' },
                { icon: <Rocket className="h-4 w-4" />, text: 'Ship in minutes, not weeks' },
                { icon: <Trophy className="h-4 w-4" />, text: 'Climb the leaderboard' },
              ].map(({ icon, text }) => (
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-5 py-12">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Sign in to your Imagine account</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/sign-up" className="font-bold text-sky-600 hover:text-sky-500 transition-colors">
              Sign up free
            </Link>
          </p>
        </motion.div>
