      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
          <div className="mb-7 text-center">
            <h1 className="text-xl font-bold text-stone-900">Create an account</h1>
            <p className="mt-1 text-sm text-stone-500">Start submitting your apps today</p>
          </div>
        ...
        <p className="mt-5 text-center text-sm text-stone-500">
          ...
          <Link href="/sign-in" className="font-medium text-teal-700 hover:text-teal-600 transition-colors">
            Sign in
          </Link>
        </p>
